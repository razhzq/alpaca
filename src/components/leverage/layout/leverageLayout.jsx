...
const LeverageLayout = ({ title }) => {
  ...
  const onCalculate = () => {
    ...
    //Added setTimeout to demonstrate loading state
    setTimeout(() => {
      setCalStatus(true);
          ...
          <div className="flex flex-col  gap-5 h-full">
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-[120px,auto] gap-6 items-center">
              <input
                type="number"
                placeholder="0"
                className="bg-transparent outline-none text-2xl md:text-3xl text-blue font-mainBold"
                onChange={(e) => setCollateral(e.target.value)}
              />
              <CustomSelect
                onPairChange={setIsLong}
                options={select2}
                asset={select2.find((x) => x.value === isLong)}
              />
            </div>
            ...
            <div className="p-2">
              <div className="flex justify-between items-center">
                ...
                <input
                  ...
                  value={leverage}
                  onChange={(e) => {
                    setLeverage(Math.max(2, Math.min(+e.target.value, 150)));
                  }}
                />
              </div>
              <div className="mt-4">
            ...
            <div className="w-full flex flex-col gap-2">
              <button
                ...
                className="w-full py-2 bg-blue rounded-[6px] text-sm sm:text-base md:text-md text-buttonText font-mainSemibold hover:opacity-75 duration-150"
              >
                Calculate
              </button>
              <button
                onClick={() => connectWallet()}
                className="w-full py-2 bg-blueDark rounded-[6px] text-sm sm:text-base md:text-md text-buttonText font-mainSemibold hover:opacity-75 duration-150"
              >
            ...
            {isRouteLoading ? (
              ...
              <>
                <button
                  ...
                  className={`flex group hover:bg-blueDark bg-routeBackground w-full items-center justify-between px-4 py-1 rounded-[6px] transition-all`}
                >
                  <div className="flex flex-col gap-1">
                    <p className="group-hover:text-routeTextHover transition-all text-black text-sm sm:text-base font-mainRegular">
                      {gmxPrice / 10 ** 30}
                    </p>
                    <p className="group-hover:text-routeTextHover transition-all text-black text-sm sm:text-base font-mainRegular">
                      ≥ $-0.7 after fees
                  ...
                  Best
                    ...
                    <p className="text-end group-hover:text-routeTextHover transition-all text-black text-sm sm:text-base font-mainRegular">
                      via GMX
                    </p>
                  </div>
                </button>
